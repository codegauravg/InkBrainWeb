var footer = React.createClass({displayName: "footer",
                               ...
                               React.createElement("p",{className: 'navbar-text navbar-right'},
                                                   ...
                                                   React.createElement("br",null,null),"By: ",
                                                   React.createElement("a",{href: 'https://github.com/codegauravg', target: '_blank'},React.createElement("i",{className: 'fa fa-github'},null),"/codegauravg"),
